...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $$ U_dropp = R_i \times I $$ | $$ U $$ | Spänning | Volt | $$ V $$|

| Exempel uträkning spänningsfall |
|:-------------:|
| $$ U_{dropp} = R_i \times I $$ |
| $$ U_{dropp} = 0,6 \times 2,2 $$ |
| $$ U_{dropp} = 1,32 \ V $$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $$ R = \frac {p \times ^L }{A} $$ | $$ R $$ | Ledarrresistans | Omega | $$ \Omega $$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $$ R_{tot} = R_y + R_i $$ | $$ R_{tot} $$ | Resistans | Omega | $$ \Omega $$ |

| Exempel uträkning total resistans |
|:-------------:|
| $$ R_{tot} = R_y + R_i $$ |
| $$ R_{tot} = 22 + 1,2 $$ |
| $$ R_{tot} = 23,2 \Omega $$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $$ R_{i \ tot} = Antal \ Batt \times R_{I \ Batt} $$ | $$ R_{i} $$ | Resistans | Omega | $$ \Omega $$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $$ R_{i \ tot} = \frac {R_{i Batt}}{Batt_{Antal}} $$ | $$ R_{i \ tot} $$ | Resistans | Omega | $$ \Omega $$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:------------:|:-------------:|:-------------:|
| $$ I_{max} = Batt \ antal \times I_i $$ | $$ I_{max} $$ | Ström | Ampere | $$ A $$|
