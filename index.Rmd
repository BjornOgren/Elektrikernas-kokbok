...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $R = \frac {\rho \times L }{A}$ | $R$ | $Ledarresistans$ | $Omega$ | $ \Omega$ |
...
Materialkonstanten $\rho$ i resistansformeln brukar anges i sorten $[\Omega mm2/m]$. Detta förenklar beräkningar av kabelresistanser, eftersom det är naturligt att tala om kabellängder i $m$ och tvärsnittsareor av storleksordningen $mm2$ - den som inte känner till detta kan dock bli mycket förbryllad!

| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $\rho = \frac {R \times A}{L}$ | $\rho$ | $Ledarresistivitet$ | $Omega \ mm^2/m$ | $[\Omega mm^2/m]$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $L = \frac {R \times A }{\rho}$ | $L$ | $Ledarlängd$ | $Meter$ | $m$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $$ I = I_{1} + I_{2} + I_{3} ...osv $$ | $$ I $$ | Ström | Ampere | $$ A $$|
