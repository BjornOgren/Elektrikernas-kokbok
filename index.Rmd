...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $I \ genom \ varje \ R = \frac{U_f}{R}$ | $I_f$ | $Ström$ | $Ampere$ | $A$ |

| Exempel uträkning |
|:-------------:|
| $$ I \ genom \ varje \ R = \frac{U_f}{R} $$ |
| $$ I \ genom \ varje \ R = \frac{230}{100} $$ |
| $$ I \ genom \ varje \ R = 2,3 \ A $$ |
...
| Samband | Beteckning | Storhet | Enhet | Förkortning | 
|----------|:-------------:|:-------------:|:-------------:|:-------------:|
| $ I \ genom \ varje \ R = \frac{U_h}{R}$ | $I_f$ | $Fasström$ | $Ampere$ | $A$ |

| Exempel uträkning |
|:-------------:|
| $$ I \ genom \ varje \ R = \frac{U_h}{R} $$ |
| $$ I \ genom \ varje \ R = \frac{230}{100} $$ |
| $$ I \ genom \ varje \ R = 4 \ A $$ |
